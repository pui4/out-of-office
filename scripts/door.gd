...
var rooms : Array[String] = ["forwards", "left", "loop left", "loop right", "right", "T-left", "t-right", "fake_room_1", "big room 1", "big room 2", "fake room 3", "fake room 4", "dead ends", "dead ends 2"]
...
func _on_body_entered(body: Node3D) -> void:
	if body.name == "Player":
		...
		get_tree().root.add_child(room_inst)
